...
- 📋TODO: announce to bring laptop; and check if RH201 is possible and if it has computers, also try using superset with iPad and phone 
-  📋TODO: survey and announcement for streams 
- 📋TODO: decide how to collect (form?) and how long for discussion activities 
- 📋TODO: complete the instructions for the platform (assignments) and set up a test assignment in Nuku
...
![Table](img/normalise-exercise.png)
...
![Entity](img/entities-attributes.png)

---

# Relationships 

![Relationship](img/relationships.png)
...
![SQL Lab screenshot](img/superset.png)
...
# ADDITIONAL SLIDES - DON'T USE

---

# 5. DB concepts (week 2)
...
# 5. Database concepts (from week 3)

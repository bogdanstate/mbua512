...
**Query to write:** use INTERSECT to find the peopleID of people who have a planner and are themselves a planner for someone else. 
...
- **Next class**: test (please arrive on time); some additional material, and then a support workshop 

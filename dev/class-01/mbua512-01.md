...
2. Create an account (**Sign up**, top right)
   - You can use an existing Apple or Google account to create your github account
3. Go to [learn.datascie.nz](https://learn.datascie.nz/)
...
straight to [learn.datascie.nz/sqllab](https://learn.datascie.nz/sqllab/).

...
- A relationship links one or more entities, and can have attributes 

![w:1000](img/relationship-with-attributes.png)
...
## Cardinality – number of _instances_ of entities 
 ...
 ---
  ...
  ## Examples of degree and cardinality 
...
![h:300](img/cardinalities.png) ![w:600](img/relationship-with-attributes-nn.png)
...
- Relationships with attributes indicated with a dashed line from the relationship to a rectangle (not shown here)

![bg right contain](img/advisor-student-uml.png)
...
In the table below what would be a possible choice for primary key? Why?

![w:600](img/normalise-exercise.png)  ![w:500](img/key-concepts.png)
